...
if __name__ == '__main__':
    root = '/home/ubuntu/public2/cjp/FR/data'
    a = os.path.join(root,'/home/ubuntu/public2/cjp/FR/data/CASIA_WF')
    print(a)
    file_list = '/home/ubuntu/public2/cjp/FR/data/closed_list/data_file_flip_noise_10.txt'
    train_set = CASIAWebFace(root, file_list)
    print(train_set[0])